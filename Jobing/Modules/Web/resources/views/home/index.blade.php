...
@section('body')
    ...
    <!-- Banner Section -->
    <section class="py-24 bg-gradient-to-t from-orange-200 to-gray-50 bg-cover bg-center bg-no-repeat shadow-[0_14px_6px_rgba(253,230,138,0.5)]" style="background-image: url('{{ asset('images/static/HomeFormBG.png') }}');">
    ...
    <section class="process-section py-12 border border-t-2 flex justify-center items-center"
             style="background-image: url('{{asset('images/static/WhoWeAreBG.png')}}'); height: 400px; background-size: cover; background-position: center;">
            ...
            <div class="flex overflow-x-auto justify-between md:flex-row mx-4 lg:mx-1 items-center pb-4">
                ...
                <div class="flex flex-col items-center min-w-[180px] md:min-w-[280px]">
                    <div class="icon-box w-36 h-36 flex justify-center items-center mb-1 relative">
                        <img src="{{asset('images/static/WhoWeAre1.png')}}" alt="Sign Up"
                ...
                <div class="flex flex-col items-center min-w-[180px] md:min-w-[280px]">
                    <div class="icon-box w-36 h-36 flex justify-center items-center mb-1 relative">
                        <img src="{{asset('images/static/WhoWeAre3.png')}}" alt="Search"
                             class="h-24 transition-transform duration-300 transform hover:-translate-y-4">
                    </div>
                ...
                <div class="flex flex-col items-center min-w-[180px] md:min-w-[280px]">
                    <div class="icon-box w-36 h-36 flex justify-center items-center mb-1 relative">
                        <img src="{{asset('images/static/WhoWeAre2.png')}}" alt="List"
                             class="h-24 transition-transform duration-300 transform hover:-translate-y-4">
                    </div>
                ...
                <div class="flex flex-col items-center min-w-[180px] md:min-w-[280px]">
                    <div class="icon-box w-36 h-36 flex justify-center items-center mb-1 relative">
                        <img src="{{asset('images/static/WhoWeAre4.png')}}" alt="List"
                             class="h-24 transition-transform duration-300 transform hover:-translate-y-4">
                    </div>
