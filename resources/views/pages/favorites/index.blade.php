...
<div class="bg-gray-50 min-h-screen pb-16">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
            ...
            <a href="{{ route('jobs.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl border border-gray-200 bg-white hover:border-primary hover:text-primary text-gray-700 text-xs font-semibold shadow-2xs transition cursor-pointer w-fit">
        ...
        <div class="text-center py-16 bg-white rounded-2xl border border-gray-200 p-8 shadow-2xs">
            ...
            <a href="{{ route('jobs.index') }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary hover:bg-primary-dark text-white text-xs font-semibold transition shadow-xs cursor-pointer">
