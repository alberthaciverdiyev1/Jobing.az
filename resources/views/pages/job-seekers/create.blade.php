    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <form method="POST" action="{{ route('job-seekers.store') }}" class="space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-2xs p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div class="sm:col-span-2">
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Ad title') }} <span class="text-primary">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Position / Title') }}</label>
                        <input type="text" name="position" value="{{ old('position') }}" maxlength="255" placeholder="{{ __('e.g. Backend Developer') }}"
                               class="w-full px-4 py-2.5 bg-gray-50 hover:bg-white focus:bg-white border border-gray-200 rounded-lg focus:outline-hidden focus:border-primary focus:ring-1 focus:ring-primary text-sm transition">
                    </div>
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('City') }}</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Category') }}</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Job type') }}</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Workplace') }}</label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Experience level') }}</label>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-2xs p-6">
                ...
                <div class="space-y-5">
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Your experience and skills') }} <span class="text-primary">*</span></label>
                    ...
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Skills (comma separated)') }}</label>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-2xs p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Minimum salary') }}</label>
                        <input type="number" name="salary_min" value="{{ old('salary_min') }}" min="0" placeholder="1000"
                               class="w-full px-4 py-2.5 bg-gray-50 hover:bg-white focus:bg-white border border-gray-200 rounded-lg focus:outline-hidden focus:border-primary focus:ring-1 focus:ring-primary text-sm transition">
                    </div>
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Maximum salary') }}</label>
                    ...
                    <div class="sm:col-span-2">
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Availability') }}</label>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-2xs p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Full Name') }} <span class="text-primary">*</span></label>
                        <input type="text" name="contact_name" value="{{ old('contact_name', auth()->user()->name ?? '') }}" required maxlength="255"
                               class="w-full px-4 py-2.5 bg-gray-50 hover:bg-white focus:bg-white border border-gray-200 rounded-lg focus:outline-hidden focus:border-primary focus:ring-1 focus:ring-primary text-sm transition">
                    </div>
                    <div>
                        <label class="block text-xs font-semibold text-gray-700 mb-1.5">{{ __('Email') }}</label>
            ...
            <div class="flex justify-end">
                <button type="submit" class="px-8 py-3 rounded-xl bg-primary hover:bg-primary-dark text-white font-semibold text-sm shadow-md hover:shadow-lg transition duration-200 flex items-center gap-2 cursor-pointer">
