        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 relative">
            <div class="max-w-3xl mx-auto text-center space-y-4">
                ...
                <p class="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto leading-relaxed">
                    {{ __("Kariyer.KibrisKare is a digital career platform that connects Northern Cyprus' leading companies with talent across programming, design, marketing, management and other professions in the fastest and most transparent way.") }}
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10 max-w-6xl space-y-12">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5">
            <div class="bg-white rounded-2xl p-5 border border-gray-200/80 shadow-2xs hover:shadow-xs transition flex items-center gap-4">
                ...
                <div>
                    <span class="text-xl sm:text-2xl font-semibold text-gray-900 block font-mono">{{ $stats['vacancies'] }}+</span>
            ...
            <div class="bg-white rounded-2xl p-5 border border-gray-200/80 shadow-2xs hover:shadow-xs transition flex items-center gap-4">
                ...
                <div>
                    <span class="text-xl sm:text-2xl font-semibold text-gray-900 block font-mono">{{ $stats['companies'] }}+</span>
            ...
            <div class="bg-white rounded-2xl p-5 border border-gray-200/80 shadow-2xs hover:shadow-xs transition flex items-center gap-4">
                ...
                <div>
                    <span class="text-xl sm:text-2xl font-semibold text-gray-900 block font-mono">{{ $stats['resumes'] }}+</span>
            ...
            <div class="bg-white rounded-2xl p-5 border border-gray-200/80 shadow-2xs hover:shadow-xs transition flex items-center gap-4">
                ...
                <div>
                    <span class="text-xl sm:text-2xl font-semibold text-gray-900 block font-mono">{{ $stats['jobSeekers'] }}+</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white rounded-2xl p-7 sm:p-8 border border-gray-200 shadow-2xs space-y-3">
                ...
                <h3 class="text-lg font-semibold text-gray-900">{{ __('Our Mission') }}</h3>
            ...
            <div class="bg-white rounded-2xl p-7 sm:p-8 border border-gray-200 shadow-2xs space-y-3">
                ...
                <h3 class="text-lg font-semibold text-gray-900">{{ __('Our Vision') }}</h3>
                <p class="text-xs sm:text-sm text-gray-600 leading-relaxed">
                    {{ __('To become the most modern, technologically advanced and user-centred job portal in Northern Cyprus and the region; to be a trusted guide in both the local labour market and international remote work opportunities.') }}
                </p>
            </div>
        </div>

        <!-- Why Kariyer.KibrisKare (Core Features) -->
        <div class="space-y-6">
            <div class="text-center max-w-xl mx-auto space-y-2">
                <h2 class="text-2xl font-semibold text-gray-900">{{ __('Why Kariyer.KibrisKare?') }}</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div class="bg-white rounded-2xl p-6 border border-gray-200/80 shadow-2xs hover:border-primary/40 transition space-y-3">
                    ...
                    <h4 class="font-semibold text-gray-900 text-sm">{{ __('Smart Filtering') }}</h4>
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-200/80 shadow-2xs hover:border-primary/40 transition space-y-3">
                    <div class="w-10 h-10 rounded-xl bg-emerald-50 text-emerald-600 flex items-center justify-center text-base font-semibold">
                        <i class="fas fa-money-bill-wave"></i>
                    </div>
                    <h4 class="font-semibold text-gray-900 text-sm">{{ __('Transparent Salary Display') }}</h4>
                    <p class="text-xs text-gray-500 leading-relaxed">
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-200/80 shadow-2xs hover:border-primary/40 transition space-y-3">
                    ...
                    <h4 class="font-semibold text-gray-900 text-sm">{{ __('Direct & Easy Application') }}</h4>
                    <p class="text-xs text-gray-500 leading-relaxed">
                ...
                <div class="bg-white rounded-2xl p-6 border border-gray-200/80 shadow-2xs hover:border-primary/40 transition space-y-3">
                    <div class="w-10 h-10 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center text-base font-semibold">
                        <i class="fas fa-shield-alt"></i>
                    </div>
                    <h4 class="font-semibold text-gray-900 text-sm">{{ __('Verified Companies') }}</h4>
                    <p class="text-xs text-gray-500 leading-relaxed">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-2xl p-7 sm:p-8 border border-gray-200 shadow-2xs space-y-5">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="font-semibold text-gray-900 text-base">{{ __('For Candidates') }}</h3>
                ...
                <div class="pt-2">
                    <a href="{{ route('jobs.index') }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-white text-xs font-semibold hover:bg-primary-dark transition shadow-xs">
            ...
            <div class="bg-white rounded-2xl p-7 sm:p-8 border border-gray-200 shadow-2xs space-y-5">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="font-semibold text-gray-900 text-base">{{ __('For Companies & Employers') }}</h3>
                ...
                <div class="pt-2">
                    <a href="{{ route('jobs.create') }}" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-900 text-white text-xs font-semibold hover:bg-slate-800 transition shadow-xs">
        ...
        <div class="rounded-3xl bg-linear-to-r from-orange-500 to-amber-600 p-8 sm:p-12 text-white shadow-xl flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="space-y-2 text-center md:text-left">
                ...
                <p class="text-white/90 text-xs sm:text-sm max-w-xl">
                    {{ __('Whether you are looking for a new job or bringing a new professional to your team - Kariyer.KibrisKare is always by your side.') }}
                </p>
            </div>
            <div class="flex items-center gap-3 shrink-0">
                <a href="{{ route('contact.index') }}" class="px-6 py-3 rounded-xl bg-white text-gray-900 text-xs font-semibold hover:bg-gray-50 transition shadow-md">
                    {{ __('Contact Us') }}
                </a>
            </div>
        </div>
