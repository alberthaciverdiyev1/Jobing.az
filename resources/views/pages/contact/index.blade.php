        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-white rounded-2xl border border-gray-200 shadow-2xs overflow-hidden">
                ...
                <form method="POST" action="{{ route('contact.store') }}" class="p-6 sm:p-8"
                    ...
                    <div class="mt-6 flex items-center justify-between gap-4 flex-wrap">
                        <p class="text-[12px] text-gray-400">{{ __('All your information is kept confidential.') }}</p>
                        <button type="submit"
                                :disabled="submitted"
                                class="px-8 py-3 rounded-xl bg-primary hover:bg-primary-dark text-white font-semibold text-sm shadow-md hover:shadow-lg transition duration-200 flex items-center gap-2 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed">
            ...
            <div class="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="bg-white rounded-xl border border-gray-200 p-5 text-center shadow-2xs">
                    ...
                    <p class="text-sm font-semibold text-gray-800 mt-1">{{ $siteSetting->email ?: 'info@kariyer.kibriskare.com' }}</p>
                </div>
                <div class="bg-white rounded-xl border border-gray-200 p-5 text-center shadow-2xs">
                    <div class="w-10 h-10 bg-orange-50 text-primary rounded-lg flex items-center justify-center mx-auto mb-3">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-5 text-center shadow-2xs">
                    ...
                    <p class="text-sm font-semibold text-gray-800 mt-1">{{ $siteSetting->working_hours ?: 'Mon – Fri · 09:00 – 18:00' }}</p>
                </div>
            </div>
        </div>
    </div>
