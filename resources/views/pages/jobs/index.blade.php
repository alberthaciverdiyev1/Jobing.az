        ...
        <div class="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-wrap items-center justify-center gap-2 mt-4 text-xs">
                ...
                <button type="button"
                        ...
                        :class="workplace.includes('uzaktan') ? 'bg-orange-100 border-orange-300 text-primary font-semibold shadow-xs' : 'bg-orange-50/80 border-orange-200 text-orange-700 hover:bg-orange-100 hover:border-orange-300'"
