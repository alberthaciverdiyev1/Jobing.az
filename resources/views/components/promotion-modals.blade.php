        ...
        <div x-show="bumpModalOpen"
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="space-y-2 pt-1">
                    <a :href="'https://wa.me/{{ $cleanWa }}?text=' + encodeURIComponent('Merhaba, Kariyer.KibrisKare sitesindeki #{{ $id }} numaralı {{ $itemTypeLabel }} ilanını (\'{{ $safeTitle }}\') ' + selectedBump + ' KEZ ÖNE ÇIKARMAK istiyorum (' + bumpPrices[selectedBump] + ').')"
    ...
    <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
        <div x-show="premiumModalOpen"
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="space-y-2 pt-1">
                    <a :href="'https://wa.me/{{ $cleanWa }}?text=' + encodeURIComponent('Merhaba, Kariyer.KibrisKare sitesindeki #{{ $id }} numaralı {{ $itemTypeLabel }} ilanını (\'{{ $safeTitle }}\') ' + selectedPremium + ' KEZ PREMIUM YAPMAK istiyorum (' + premiumPrices[selectedPremium] + ').')"
                       target="_blank" rel="noopener"
