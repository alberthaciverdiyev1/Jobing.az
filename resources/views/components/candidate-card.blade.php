...
<div {{ $attributes->merge(['class' => ($isSeekerFeatured ? 'bg-amber-50/20 border-amber-300 hover:border-amber-400' : 'bg-white border-gray-200 hover:border-gray-300') . ' rounded-xl p-4 md:p-5 border hover:shadow-xs transition-all duration-200 group flex flex-col justify-between relative cursor-pointer @container']) }}>
