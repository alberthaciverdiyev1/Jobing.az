<head>
    ...
    <!-- <title>�n Son Vakansiyalar - M端hasib, Proqramist v� Daha �ox | Jobing.az</title> -->
    <meta name="google-adsense-account" content="ca-pub-6130649958615254">
    <meta name="description" content="Az�rbaycanda �n son vakansiyalar! B端t端n yeni i� elanlar脹n脹 Jobing.az-da tap脹n.">
    <meta name="keywords"
          content="hellojob, vakansiya, boss.az vakansiya, restoran vakansiya, otel vakansiya, i� elanlar脹, �n son vakansiyalar, jobing.az">
    <title>
        <%= title %>
    </title>
    ...
    <link rel="stylesheet" href="/Css/Libraries/Alertify/alertify.min.css">
    <link rel="stylesheet" href="/Css/Libraries/salarySlider.min.css">
    <link rel="stylesheet" href="/Css/Libraries/Ckeditor5.min.css">
    <!-- <link rel="stylesheet" href="/Css/Libraries/Ckeditor/ckeditor5-editor.css"> -->
