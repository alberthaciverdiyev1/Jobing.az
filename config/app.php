...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Site adı logo, sayfa başlıkları ve SEO başlıklarında config üzerinden
    | okunur. `brand_name` logoda vurgusuz yazılan kelime, `brand_suffix`
    | ise logoda birincil renkle vurgulanan uzantıdır (örn. ".az").
    | `full_name` bunların birleşiminden oluşur ve başlıklarda kullanılır.
    |
    */
